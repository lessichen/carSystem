...
public interface CarDao {
    ...
    @Select("select * from carMessage where concat(carName,carType,carSeries) REGEXP #{like} limit #{dateBegin},#{pageSize} ")
    List<Car> findPageDataByCarLike(String like, int dateBegin, int pageSize);
}
